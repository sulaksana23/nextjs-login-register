          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={getInputClass(Boolean(formState.fieldErrors?.name))}
